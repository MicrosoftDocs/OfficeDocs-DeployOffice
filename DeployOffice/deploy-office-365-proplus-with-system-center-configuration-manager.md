...
4. Clik **OK**, right-click the deployment type and select  **Update Content**. For more details, see [Deploy and manage content](https://docs.microsoft.com/sccm/core/servers/deploy/configure/deploy-and-manage-content#bkmk_manage).
