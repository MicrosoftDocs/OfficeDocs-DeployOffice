...
- Office will be installed and receive updates using System Center Configuration Manager
    
- Office 365 ProPlus will be deployed in English and Japanese and in both 32-bit and 64-bit editions
...
Based on these requirements, we'll create four deployment groups: groups 1 and 2 will be 32-bit and 64-bit, respectively, and  will receive updates from Semi-Annual Channel. Groups 3 and 4 will be the pilot groups. Group 3 will recieve the 32-bit edition and group 4 the 64-bit edition. Both groups 3 and 4 will receive updates from Semi-Annual Channel (Targeted).
