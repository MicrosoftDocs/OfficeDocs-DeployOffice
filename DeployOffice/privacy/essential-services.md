...
- **Data_EcsCountry** - Detected country/region
...
- **Device_NetworkCountry** - The device country/region (based on IP address)
...
- **PipelineInfo_ClientCountry** - The device country/region (based on IP address)
