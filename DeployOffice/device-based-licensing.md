...
&nbsp; &nbsp; **Transition from Subscription or Shared Computer Licensing to Device Based Licensing** 

If Microsoft 365 Apps  are already installed and activated with user based subscription or Shared Computer Licensing you will need to reset the license state on the device before it will transition over to Device Based Licensing. To reset activation state follow instructions on https://docs.microsoft.com/en-us/office/troubleshoot/activation/reset-office-365-proplus-activation-state 
