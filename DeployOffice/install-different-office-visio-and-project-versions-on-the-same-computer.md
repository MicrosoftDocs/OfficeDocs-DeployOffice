...
- To install Project 2019 or Vsio 2019 or Project LTSC 2021 or Visio 2021 LTSC after Office 365 gets installed, update channel should be same for all the these products. For example: if Office 365 is installed with Monthly Enterprise Channel then Project 2019 or Visio 2019 or Project LTSC 2021 or Visio LTSC 2021 should be installed with Monthly Enterprise Channel only or with respective channel on which Office 365 application has been installed.
