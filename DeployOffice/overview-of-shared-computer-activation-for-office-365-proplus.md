...
> [!NOTE]
> You also can use shared computer activation to install Visio Pro for Office 365 or Project Online Desktop Client on a shared computer, if you have a subscription plan that includes those products. <br/>Shared computer activation isn't available for Office 2016 for Mac.
