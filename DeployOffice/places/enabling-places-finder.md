...
|Recent Building |Supports recent buildings (room list)  |Building set from workplan or from user’s booking history |
...
|Room Suggestions |No suggestions  |**In Places web app**:<br>Suggestions based on historical bookings<br>Suggestion based on building (from Work Plan)<br>Suggestion based on number of in-office attendees for the meeting<br>**In Calendar**:<br>Suggestions based on building (from Work Plan) |
|Workspace Suggestions |No suggestions    |**In Places web app**:<br>Suggestions based on historical bookings<br>Suggestion based on building (from Work Plan)<br>Suggestion based on number of in-office attendees for the meeting<br>**In Calendar**:<br>Suggestions based on building (from Work Plan)   |
