...
- **What happens when I click “Sign up for access”?**
    ...
    The tenant you are signed into will be added to a priority waitlist for the new Cloud Update experience. You will be notified through in-product notifications once this feature is available to try.
...
- **Can I remove my tenant(s) from the waitlist once I’ve signed up?**
    ...
    No. You can’t undo your choice once you’ve signed up, but you can choose to not to activate this feature once it’s available.
