...
- Office cloud policy service supports security groups and mail-enabled security groups in Azure AD. The groups can be either cloud-only or synchronized. The membership type can be either Dynamic or Assigned.
