...
:::image type="content" source="./media/deployment-guide-onenote/notebook-information-small.png" alt-text="This image displays the OneNote application's Notebook Information section. The interface includes a navigation bar with various options and a main panel showing Migration settings with a file path. There are icons for View Sync Status and Open Backups in the upper right corner" lightbox="./media/deployment-guide-onenote/notebook-information.png":::
