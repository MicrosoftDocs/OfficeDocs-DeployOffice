...
> - Microsoft 365 Apps is supported on Windows Server 2022 only until October 2026. This support in currently in preview. For more information, see [Windows Server end of support and Microsoft 365 Apps](endofsupport/windows-server-support.md#windows-server-2022).
