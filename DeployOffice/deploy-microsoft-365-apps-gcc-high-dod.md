...
> - We’re making some changes to the update channels for Microsoft 365 Apps for enterprise, including adding a new update channel (Monthly Enterprise Channel) and changing the names of the existing update channels. To learn more, [read this article](update-channels-changes.md).
