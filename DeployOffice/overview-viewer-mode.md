...
:::image type="content" source="./media/overview-viewer-mode/viewer-mode-notification.png" alt-text="Viewer mode notification indicating Word is configured for view and print only.":::
