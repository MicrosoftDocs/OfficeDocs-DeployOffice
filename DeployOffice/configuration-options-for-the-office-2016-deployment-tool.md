...
description: "With the Office Deployment Tool (ODT), you can download and deploy Office 365 ProPlus to your client computers. The ODT gives you more control over an Office installation: you can define which products and languages are installed, how those products should be updated, and whether or not to display the install experience to your users. This article covers all the available options in the tool. To learn how to use the tool itself, see Overview of the Office 2016 Deployment Tool."
---
...
If you're not an enterprise administrator and are looking to install Office 365 in your home or business, see [Download and install or reinstall Office 365 or Office 2016 on your PC or Mac](http://technet.microsoft.com/library/4414eaaf-0478-48be-9c42-23adc4716658%28Office.14%29.aspx).
  
## Key tasks

Based on customer feedback, most people who visit this article want to do one of the following:
  
|**Task**|**Solution**|
|:-----|:-----|
|Download the Office 2016 Deployment Tool.  <br/> |You can download the Office 2016 Deployment Tool from [here](http://go.microsoft.com/fwlink/p/?LinkID=626065).  <br/> |
|Find a Product ID  <br/> |[Click here](https://go.microsoft.com/fwlink/p/?LinkID=301891) for a list of all supported product IDs. <br/> |
|Install Office offline on a single computer  <br/> |[Use the Office 2016 offline installer](http://technet.microsoft.com/library/f0a85fe7-118f-41cb-a791-d59cef96ad1c%28Office.14%29.aspx) to download Office and install it offline. <br/> |
|Install or remove a specific Office application, such as Access or Excel, from a single computer.  <br/> |While it's technically possible to use the Office 2016 Deployment Tool to install or remove specific applications from a single computer, we don't recommend it. If you want to request this capability, click **File > Feedback** in any Office app. Office developers at Microsoft read this feedback. For more details, see[How do I give feedback on Microsoft Office?](http://technet.microsoft.com/library/2b102d44-b43f-4dd2-9ff4-23cf144cfb11%28Office.14%29.aspx).  <br/> |
   
If you don't see your task listed above and cannot find a solution in this article, please let us know below. We'll use your feedback to update this article and provide additional information.
...
|Channel="Broad"  <br/> |After installation, Office will be updated using the Semi-Annual Channel.  <br/> |
...
|**Channel** attribute (part of Add element) <br/> |Defines which channel to use for updating Office after it is installed.  <br/> Optional. The default is **Broad** for Office 365 ProPlus and **Monthly** for Visio Pro for Office 365 and Project Online Desktop Client. <br/> For more information about update channels, see [Overview of update channels for Office 365 ProPlus](overview-of-update-channels-for-office-365-proplus.md).  <br/> |For Semi-Annual Channel, use  `Channel="Broad"` <br/> For Semi-Annual Channel (Targeted), use  `Channel="Targeted"` <br/> For Monthly Channel, use  `Channel="Monthly"` <br/> For Monthly Channel (Targeted), use  `Channel="Insiders"` <br/> Previous values, such as Deferred and FirstReleaseDeferred, are still supported.  <br/> |
...
|**SharedComputerLicensing** property (part of Property element) <br/> |Set **SharedComputerLicensing** to 1 if you deploy Office 365 ProPlus to shared computers by using Remote Desktop Services. <br/> For more information, see [Overview of shared computer activation for Office 365 ProPlus](overview-of-shared-computer-activation-for-office-365-proplus.md).  <br/> Optional. Default value is **0**. <br/> |
```
<Property Name="SharedComputerLicensing"
          Value="0"/>
```
...
|
|**SCLCacheOverride** property (part of Property element) <br/> |Set **SCLCacheOverride** to 1 if you're using shared computer activation and you want to roam the licensing token. Use in conjunction with **SCLCacheOverrideDirectory**. <br/> For more information, see [Overview of shared computer activation for Office 365 ProPlus](overview-of-shared-computer-activation-for-office-365-proplus.md).  <br/> Optional. Default value is **0**. <br/> |
```
...
|
|**SCLCacheOverrideDirectory** property (part of Property element) <br/> |Use **SCLCacheOverrideDirectory** to specify a folder location for the licensing token if you're using shared computer activation and you want to roam the licensing token. Use in conjunction with **SCLCacheOverride**. <br/> For more information, see [Overview of shared computer activation for Office 365 ProPlus](overview-of-shared-computer-activation-for-office-365-proplus.md).  <br/> Optional.  <br/> |
```
