...
|**Area**|**What's changed**|**More information**|
|:-----|:-----|:-----|
|Autodiscover  <br/> |Outlook 2016 requires Autodiscover to be configured, or it won't be able to connect to Exchange Server.  <br/> |Outlook 2016 retrieves Exchange Server connectivity settings directly from Autodiscover instead of the registry, making profiles more reliable, but that also makes Autodiscover a required feature.  <br/><br/> [Errors when you upgrade to Office 2016](/exchange/troubleshoot/setup/upgrade-errors-office-2016) <br/> |
