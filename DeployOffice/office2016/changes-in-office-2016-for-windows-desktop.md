...
|:-----|:-----|:-----|
|Clip Art  <br/> |The Office.com Clip Art and image library has been removed.  <br/> |[Clip Art now powered by Bing Images](https://www.microsoft.com/microsoft-365/blog/2014/12/01/clip-art-now-powered-bing-images/) <br/><br/> [Add online pictures or clip art to your file](https://support.microsoft.com/office/0a01ae25-973c-4c2c-8eaf-8c8e1f9ab530) <br/> |
|Document Information Panel  <br/> |The Document Information Panel has been removed.  <br/> |[Where is the Document Information Panel in Office 2016?](https://support.microsoft.com/office/767bbbbb-27aa-42e8-81dc-9ed5cf06e6e0) <br/> |
...
|**Area**|**What's changed**|**More information**|
|:-----|:-----|:-----|
|Autodiscover  <br/> |Outlook 2016 requires Autodiscover to be configured, or it won't be able to connect to Exchange Server.  <br/> |Outlook 2016 retrieves Exchange Server connectivity settings directly from Autodiscover instead of the registry, making profiles more reliable, but that also makes Autodiscover a required feature.  <br/><br/> [Errors when you upgrade to Office 2016](https://docs.microsoft.com/exchange/troubleshoot/setup/upgrade-errors-office-2016) <br/> |
