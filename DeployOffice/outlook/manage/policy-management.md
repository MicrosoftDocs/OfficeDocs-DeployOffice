...
:::image type="content" source="../manage/media/policy-management/policy-allow-access-contact.png" alt-text="A screenshot of the Allow access to Contact Support in the new Outlook policy settings, showing default, enabled, and disabled configurations, and a note on diagnostic troubleshooting. The configuration setting is shown as "Disabled.":::
