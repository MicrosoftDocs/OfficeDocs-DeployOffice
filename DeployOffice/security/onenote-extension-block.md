...
This change affects OneNote for Microsoft 365, as well as certain retail and volume license versions on Windows devices. It doesn't affect OneNote on Mac, Android, iOS, OneNote for the web, or OneNote for Windows 10.
