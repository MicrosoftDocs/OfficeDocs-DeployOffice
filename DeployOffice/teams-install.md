...
- If you are using Office deployment tool to deploy Teams separately then you will need to match the bitness and architecture for installation along with apps include else it will remove the installed apps from the system.
