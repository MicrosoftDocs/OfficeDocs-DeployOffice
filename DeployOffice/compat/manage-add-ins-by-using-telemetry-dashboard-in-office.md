...
:::image type="content" source="/DeployOffice/compat/media/manage-add-ins-by-using-telemetry-dashboard-in-office/managing-addins-telemetry.png" alt-text="Office 2013 telemetry data table showing success rate, load time, and application details alongside group policy settings.":::
