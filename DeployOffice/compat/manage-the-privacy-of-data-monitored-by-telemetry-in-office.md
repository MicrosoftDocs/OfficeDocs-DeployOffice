...
:::image type="content" source="/DeployOffice/compat/media/manage-the-privacy-of-data-monitored-by-telemetry-in-office/telemetry-privacy-methods.png" alt-text="Image showing three methods to manage privacy in Office telemetry: obfuscate document details, exclude certain applications from reporting, and set thresholds for user counts.":::
