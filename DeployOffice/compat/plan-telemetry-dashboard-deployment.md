...
|![This icon represents the database for Office Telemetry Dashboard.](../images/ORK_Telem_TelemetryDatabaseIcon.gif)| Database: <br/> <br/> - Provides a data source for Office Telemetry Dashboard.  <br/> - Requires SQL Server 2005, SQL Server 2008, SQL Server 2008 R2, SQL Server 2012, SQL Server 2014, or SQL Server 2016.  <br/> - Can be run on SQL Express editions in test or small environments.  <br/> - Can be run on the same computer as other components.  <br/> |
