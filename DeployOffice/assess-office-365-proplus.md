...
- Office 365 updates vary in size, but you can go to [Download sizes for updates to Office 365 ProPlus](https://docs.microsoft.com/officeupdates/download-sizes-office365-proplus-updates) to review recent download sizes. For details on the frequency and type of updates based on channel, see [Overview of update channels for Office 365 ProPlus](overview-of-update-channels-for-office-365-proplus.md).  
