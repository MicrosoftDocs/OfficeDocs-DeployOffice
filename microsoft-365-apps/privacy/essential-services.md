...
RThis event is triggered when a user runs the Office installer to modify their Office installation. The data allows us to carry the user's product, language, and choice of 64-bit or 32-bit Office to in-process within setup.exe.
...
- **metricName** - name of the metric event, e.g., Duration, CrashCount, Count

- **metricValue** - value for metric name, e.g., Duration - time taken
