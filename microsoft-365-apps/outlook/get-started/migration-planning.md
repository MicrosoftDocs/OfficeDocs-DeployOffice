---
title: "Migrate from classic Outlook to new Outlook"
ms.author: janellem
...
Detailed planning is important when upgrading a critical software application. Outlining a robust plan helps mitigate risks, allocate resources accordingly, minimize downtime, and ensure the productivity of your team is minimally affected.

### Project checklist

A migration checklist helps ensure you complete all key activities in preparation for your upgrade to new Outlook. This checklist should include tasks like building your team, defining your project scope, preparing your environment, and conducting a pilot. You can access a checklist template in the [New Outlook for Windows Migration Kit](https://aka.ms/newOutlookAdoption).
...
Consider feature requirements and overlap, experience considerations, and the velocity of moving users over. Access a sample table to track requirements in the [New Outlook for Windows Migration Kit](https://aka.ms/newOutlookAdoption).
...
**Toggle in / out**
You can switch to new Outlook by using the toggle found in the classic Outlook for Windows app. This closes out the classic Outlook client and opens new Outlook for Windows.
...
1. Download **[Setup.exe](https://res.cdn.office.net/nativehost/5mttl/installer/v2/prod/Setup.exe)**.
...
To deploy this installer to a group of computers or to your entire organization, use Intune, Microsoft Endpoint Configuration Manager, Group Policy, or a non-Microsoft distribution software to distribute the installer to your target computers. Run the installer on each computer.

### Manage settings and updates
...
### Manage the Try new Outlook toggle

The toggle to try new Outlook (located in the top right window of classic Outlook) is available to Semi-Annual Channel users as of build 16731.20504 (out of July fork, as of January 2024), and it's now available in Current Channel, Monthly Enterprise Channel, and Semi-Annual Channel.

The toggle is only available to users with supported accounts. Exchange on-premises is currently unsupported. Admins can control visibility of the toggle via a registry value.

### Release details

For more information on build numbers related to each of the upcoming releases, see [Progressive stages of migration to new Outlook](guide-product-availability.md).
...
New Outlook for Windows can be deployed through the classic Outlook for Windows in-app toggle and the Windows app store for end users. Admins can deploy through Intune Configuration manager and scripts.
